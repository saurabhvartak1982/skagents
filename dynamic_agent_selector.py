...
async def main():
    ...
    If not, provide insight on how the Agent can improve on their suggestion.
    """
    agent_leader = ChatCompletionAgent(
        service_id="agentleader",
        kernel=_create_kernel_with_chat_completion("agentleader"),
    ...
    agent1 = ChatCompletionAgent(
        service_id="agent1",
        kernel=_create_kernel_with_chat_completion("agent1"),
        name=AGENT1_NAME,
    ...
    agent2 = ChatCompletionAgent(
        service_id="agent2",
        kernel=_create_kernel_with_chat_completion("agent2"),
        name=AGENT2_NAME,
